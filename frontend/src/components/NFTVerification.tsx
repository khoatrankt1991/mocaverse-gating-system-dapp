...
export default function NFTVerification({
  ...
  const { checkEligibility, isReadingContract, isChecking, error } =
    useNFTVerification(address)
    ...
    <div className="mx-auto w-full max-w-md">
      <Card>
        ...
        <CardContent className="space-y-4">
          {!isConnected ? (
            <>
              <div className="rounded-lg bg-slate-700/50 p-4 text-sm text-slate-300">
